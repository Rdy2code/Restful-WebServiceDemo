...
public class RequestPackage implements Parcelable {
    ...
    //Uses a map interface, which can be parsed and passed around because both types are strings
    //In a GET request, the parameters are appended to the URL. In a POST request the parameters
    //are put into the body of the request.
